...
function Footer() {
  return (
    <footer className="footer footer-center p-10 bg-base-200 bg-footer text-base-content rounded align-bottom mt-2">
      ...
      <aside>
        <p>Copyright © 2024 - All right reserved by SportSplash</p>
      </aside>
    </footer>
  );
}
